"""
Django settings for FlexShredMaster project.
...
SECRET_KEY = 'django-insecure-cm^b19itv%g^nk-sjkfj1w2)zcigkxcr&iv(n80jf%_^k%toe3'
...
ROOT_URLCONF = 'FlexShredMaster.urls'
...
WSGI_APPLICATION = 'FlexShredMaster.wsgi.application'
